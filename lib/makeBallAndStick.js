...
export const makeBallAndStick = ({color}, rx, ry, rz) => {
...
export const makeED = (rx, ry, rz) => {
          const material = new THREE.MeshPhongMaterial({color:"#1c538e"});
          let ballAndStickGeometry = new THREE.Geometry();
          const ballGeometry = new THREE.SphereGeometry( 3.35, 32, 32 );
          const stickGeometry = new THREE.CylinderGeometry(3, .1, 5, 24, 20);
          let ballMesh = new THREE.Mesh(ballGeometry, material);
          let stickMesh = new THREE.Mesh(stickGeometry, material);
          ballMesh.position.set(0,8,0);
          stickMesh.position.set(0,4,0);
