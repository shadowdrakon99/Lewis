...
export default class extends Component {
  render() {
    ...
    let cubeStyle = {height:50, width:50, borderWidth:1, borderColor:'#5edced' }
    ...
    return(
      <View style={{position:'absolute', left:0, top:0, bottom:0, right:0, flexWrap:'wrap', backgroundColor:'#d7e0ed'}}>
        {cubeArr}
      </View>
    )
  }
